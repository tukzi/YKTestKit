...
//  FastPay
//
//  Created by song.he on 2017/9/22.
//  Copyright © 2017年 song.he. All rights reserved.
//
                     ...
                     refreshCache:(BOOL)refreshCache
                         ...
                         progress:(HYBGetProgress)progress
                          success:(HYBResponseSuccess)success
                             fail:(HYBResponseFail)fail;
// 不指定host 多一个host参数
+ (HYBURLSessionTask *)getWithHost:(NSString *)host
                               Url:(NSString *)url
                            params:(NSDictionary *)params
                           success:(HYBResponseSuccess)success
                              fail:(HYBResponseFail)fail;
...
// 不指定host 多一个host参数
+ (HYBURLSessionTask *)postWithHost:(NSString *)host
                                Url:(NSString *)url
                             params:(NSDictionary *)params
                            success:(HYBResponseSuccess)success
                               fail:(HYBResponseFail)fail;
